        ...
        blocks: [
            {
                ...
                text: {
                    type: 'mrkdwn',
                    text: 'Välj en användare ifrån listan för att få mer information om denne.'
                },
                accessory: {
                    action_id: 'text1234',
                    type: 'users_select',
...
const welcomeMessage = data => {
    return {
        blocks: [
        {
            ...
            text: {
                type: 'mrkdwn',
                text: 'Hallå där 👋 Mitt namn är IBM-boten och min uppgift är att lista användbara kommandon och ge information om våra medarbetare.'
            },
            accessory: {
                type: 'image',
                image_url: 'https://www.freepnglogos.com/uploads/ibm-logo-png/ibm-logo-ibm-vector-logo-download-logoepsm-19.png',
                alt_text: 'IBM Logo'
            }
        },
        {
        ...
        },
        {
            ...
            text: {
                type: 'mrkdwn',
                text: '*:three: Använd `/jokes` * _Berättar_ slumpvisa Chuck Norris skämt.'
            }
        },
        {
            type: 'section',
            text: {
                type: 'mrkdwn',
                text: '*:four: Använd `/weather <stad>` * Ger dig information om vädret samt temperatur.'
            }
        },
        {
            type: 'divider'
